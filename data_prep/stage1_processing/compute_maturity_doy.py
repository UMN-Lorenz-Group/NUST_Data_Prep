...
Usage:
    python compute_maturity_doy.py --pdf input_files/input_1980/1980_done.pdf --year 1980
"""
...
# Config
# ---------------------------------------------------------------------------
OUT_DIR = Path("output_files/output_1980")
YEAR = 1980
...
def main():
    ...
    ap.add_argument("--pdf",  default="input_files/input_1980/1980_done.pdf", help="Path to source PDF")
