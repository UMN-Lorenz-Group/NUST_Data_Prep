...
SCRIPTS_DIR <- "C:/Users/vramasub/Desktop/UMN_GIT/NUST_Data_Prep/data_prep/stage1_processing/"

# ─── USER: configure per run ─────────────────────────────────────────────────
YEAR <- "1980"

# Folder containing Phase 2 Python output CSVs (*_phenotypes.csv, etc.)
HIST_CSV_DIR <- "C:/Users/vramasub/Desktop/UMN_GIT/NUST_Data_Prep/output_files/output_1980/"

# Working directory where intermediate files will be written and Files4Upload/ created
DATA_DIR <- "C:/Users/vramasub/Desktop/UMN_Projects/NUST_Projects/NUST_Data/NUST_Historical_Data_1941_1988/1980_Processing/"
# ─────────────────────────────────────────────────────────────────────────────
