...
Usage:
    ...
    python pdf_pipeline.py --pdf input_files/input_1980/1980_done.pdf --year 1980 --csv_dir output_files/output_1980/

    # Resume from existing session (skip re-upload, re-run only missing queries)
    python pdf_pipeline.py --session output_files/output_1980/pdf_session_1980.json --csv_dir output_files/output_1980/
    ...
    python pdf_pipeline.py --session output_files/output_1980/pdf_session_1980.json --queries roster
"""
